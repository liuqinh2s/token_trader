...
4. 精筛 (瞬时)
   币龄<=1h && 进度>=20% && 0.000005<=价格<=0.00002 && 1h涨幅<=500% && 持币>=5 && 非首轮进度不倒退 && KOL/聪明钱持仓占比任一>=3%
   → 全部条件 AND
...
| 1 | 币龄 | ≤ 1h |
| 2 | 进度 | ≥ 20% |
| 3 | 当前价 | 0.000005 ~ 0.00002 |
| 4 | 1h 涨幅 | ≤ 500% |
| 5 | 持币数 | ≥ 5 |
| 6 | 进度趋势 | 非首轮扫描时，本轮进度 ≥ 上轮进度 |
| 7 | 关键持仓 | KOL 持仓占比 ≥ 3% 或 聪明钱持仓占比 ≥ 3% |
| 8 | Top10 持仓 | 币安 Web3 数据 ≤ 20% |
...
| #   | 策略            | 条件                                                            | 说明                                 |
| --- | --------------- | --------------------------------------------------------------- | ------------------------------------ |
| 1   | 回撤止盈        | 买入后立即跟踪最高价；最高涨幅 ≤ 30% 时，价格从最高价下跌 15%   | 刚买入时最高价即买入价，跌 15% 立即卖 |
