...
| #   | 加分项      | 说明 |
| --- | ----------- | ---- |
| 1   | 进度异动    | 仅未毕业代币，近 3 轮进度增加 ≥ 10 个百分点 |
| 2   | 价格异动    | 近 3 轮价格涨幅 ≥ 10% |
| 3   | 成交额异动  | 本轮成交额 > 前 6 根成交额之和，且本轮成交额 ≥ 500u |
| 4   | 流动性异动  | 仅已毕业代币，本轮流动性增加 ≥ 5%，且流动性 ≥ 10000u |

旧版“限制条件 + 基础标签 + 加分标签 + K线防线”策略已在代码中备份为 `tag_filter_legacy_v18`, 当前不参与开仓。
