...
| #   | 策略            | 条件                                                            | 说明                                 |
| --- | --------------- | --------------------------------------------------------------- | ------------------------------------ |
| 1   | 回撤止盈        | 最高涨幅 ≤ 30% 时，价格从最高价下跌 15%                         | 小涨幅阶段锁定利润                   |
| 2   | 盈利回撤止盈    | 最高涨幅 ≥ 30% 时，当前盈利回撤到最高盈利的一半                 | 大涨后保留一半最大利润               |
| 3   | 超期卖出        | 买入超过 15 分钟仍不赚钱                                        | 动能不足就退出                       |
...
| `trading.tp_midpoint_pct` | 30     | 盈利回撤一半止盈触发涨幅（%） |
| `trading.tp_drawdown_pct` | 15     | 低于 30% 涨幅时的最高价回撤止盈比例（%） |
| `trading.time_stop_minutes` | 15     | 超期卖出等待分钟    |
